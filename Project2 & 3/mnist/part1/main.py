...
# print("pca softmax test error",test_error)
...
# print("cubic feature softmax test error",test_error)
...
# train_x_centered, feature_means = center_data(train_x)
# pcs = principal_components(train_x_centered)
# train_pca_10 = project_onto_PC(train_x, pcs, n_components, feature_means)
# test_pca_10 = project_onto_PC(test_x, pcs, n_components, feature_means)
# print("SVM running")
# # svm = SVC(kernel='poly', degree=3, random_state=0)
# svm = SVC(kernel='rbf', degree=3, random_state=0)
# print("fit running")
# svm.fit(train_pca_10, train_y)
# print("prediction")
# # Make predictions on the test data
# pred_test_y = svm.predict(test_pca_10)
# test_error = compute_test_error_svm(test_y, pred_test_y)

# print(f"SVM cubic feature test error: {test_error:.4f}")